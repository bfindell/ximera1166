...
\begin{problem}
Answer: For a fixed perimeter, a circle is the figure with maximal area.  A circle of ``perimeter'' 20 will have a radius of approximately $\answer[tolerance=0.005]{3.183}$. % exactly $\answer{10/pi}$
