...
\item In figure $C$, none of the sides are horizontal or vertical, but area = $\answer{18}$.
\item In figure $C$, $MN = \answer{\sqrt{40}}$, so if $\overline{MN}$ is the base, the height must be $\answer{18/\sqrt{40}}$.
