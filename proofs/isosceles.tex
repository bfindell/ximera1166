...
\begin{problem}
Let's summarize the work so far:  When trying to prove that the base angles of an isosceles triangle are congruent, it is often useful to draw an additional line in the figure.  

Which of the following lines can lead to a correct proof? [Select all.]
\begin{selectAll}
\choice{median}
\choice{angle bisector}
\choice{perpendicular bisector}
\choice{altitude}
\end{selectAll}
\end{problem}

Next we consider a proof that does not involve drawing a new line. 
