...
\item If Venn diagram (A) above shows the relationship between sets $X$ and $Y$, then we say that \wordChoice{\choice{$X$ and $Y$ are disjoint}\choice[correct]{$X\subset Y$}\choice{$Y\subset X$}}.
