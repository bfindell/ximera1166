...
\begin{selectAll}
\choice[correct]{$2\in \{3, 2, 5\}$.}
\choice{$2\subseteq \{3, 2, 5\}$.} 
\choice{$\{2\}\in \{3, 2, 5\}$.}  
\choice[correct]{$\{2\}\subseteq \{3, 2, 5\}$.}  
\choice[correct]{$\{ \} \subseteq \{3, 2, 5\}$.} 
\end{selectAll}
...
Select all true statements: 
\begin{selectAll}
\choice[correct]{$\emptyset = \{ \}$.} 
\choice{$\emptyset = \{ \emptyset \} $.}
\choice[correct]{$\emptyset \in \{ \emptyset \} $.} 
\choice[correct]{$\{ \emptyset \} = \{\{\}\}$.} 
\choice[correct]{$\emptyset \subseteq \{ \emptyset \} $.} 
\end{selectAll}
\end{problem}
\end{problem}
...
Select all true statements: 
\begin{selectAll}
\choice{$2 \in \{ \{3,2,7\}, \{4,5\}, \{2\}, \emptyset \}$.} 
\choice{$2 \subseteq \{ \{3,2,7\}, \{4,5\}, \{2\}, \emptyset \}$.} 
\choice[correct]{$\{2\} \in \{ \{3,2,7\}, \{4,5\}, \{2\}, \emptyset \}$.} 
\choice{$\{2\} \subseteq \{ \{3,2,7\}, \{4,5\}, \{2\}, \emptyset \}$.} 
\end{selectAll}
\begin{problem}
Select all true statements: 
\begin{selectAll}
\choice{$\{\{2\}\} \in \{ \{3,2,7\}, \{4,5\}, \{2\}, \emptyset \}$.} 
\choice[correct]{$\{\{2\}\} \subseteq \{ \{3,2,7\}, \{4,5\}, \{2\}, \emptyset \}$.}
