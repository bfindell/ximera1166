...
For each set expression below, identify the Venn diagram above in which the region is shaded: 
\begin{enumerate}
...
\end{image}
If the above Venn diagram shows the relationship between sets $X$ and $Y$, then $X\cap Y =$ \wordChoice{\choice{$0$}\choice[correct]{$\emptyset$}\choice{$X\cup Y$}} and the sets are said to be $\answer[format=string]{disjoint}$.
