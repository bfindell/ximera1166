...
\begin{question}
In preparation for the midsegment theorem, the class proved several useful theorems about parallelograms. Which of the following statements are theorems about parallelograms?  
\begin{selectAll}
...
Here is the proof with reasons: 
\begin{enumerate}
