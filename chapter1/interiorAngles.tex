...
\begin{freeResponse}
\begin{hint}
In Bart's triangulation, the interior angles of the quadrilateral are composed only of interior angles of the triangles.  But in Brad's triangulation, new angles have been created at a vertex between $A$ and $D$.  Also notice that part of interior angle $C$ has been lost!  
\end{hint}
\end{freeResponse}
\end{problem}
