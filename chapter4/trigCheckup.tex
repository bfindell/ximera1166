...
\begin{problem}
What are the ratios of side lengths in a $45^\circ$-$45^\circ$-$90^\circ$ triangle from shortest to longest?  $1: \answer{1} : \answer{\sqrt{2}}$. 

Explain where the ratios come from, including why they work for any such triangle, no matter what size.  \begin{hint} Think of half of a square.  Then use the Pythagorean Theorem.) \end{hint}
\end{problem}


\begin{problem}
What are the ratios of side lengths in a $30^\circ$-$60^\circ$-$90^\circ$ triangle, from shortest to longest?  $1 : \answer{\sqrt{3}} : \answer{2}$. 
...
\sin\alpha = \answer{y/r}, \quad
 \cos\alpha = \answer{x/r}, \quad
  \tan\alpha = \answer{y/x}
\]
\item What values of $\alpha$ make sense in \emph{right triangle trigonometry}?  $\answer{0}\; \textrm{degrees} \le \theta < \answer{90}\; \textrm{degrees}$.  (We overcome these bounds for circular trigonometry.)  
...
\]
\[
\sin\beta = \answer{x/r} \qquad\qquad \cos\beta = {y/r}
\]
...
\begin{problem}
Suppose $\sin\alpha = \frac{3}{5}$.  Then $\cos\alpha = \answer{\sqrt{7}/5}$, $\tan\alpha = \answer{3/\sqrt{7}}$.  
...
\begin{hint}Draw a picture with $y$ representing the height of the flagpole and $d$ representing the length of wire.  From the picture, $\tan 25^\circ = \frac{y}{30}$.  Solve for $y$.  Also from the picture, $\cos 25^\circ = \frac{30}{d}$.  
\end{hint}
\end{problem}
