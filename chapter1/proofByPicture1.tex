...
\begin{problem}
Explanation 2: The whole triangle is made up of two right triangles.  Call the bases of the small right triangles $b_1$ and $b_2$, and call the base of the large (combined) triangle $b$.  
\begin{image}
%\includegraphics{pbpDisTri.png}
\definecolor{qqwuqq}{rgb}{0.,0.392,0.}
\begin{tikzpicture}
...
Then the base of the whole $b=\answer{b_1+b_2}$, and the three triangles all have the same height, $\answer{h}$.   The area of the whole triangle is the sum of the areas of the two right triangles:  
\[
\mathrm{Area} =  \answer{\frac{hb_1}{2}}+ \answer{\frac{hb_2}{2}}= \frac{h(b_1 + b_2)}{2} = \answer{bh/2}
\]
because $b=b_1+b_2$.
\end{problem}
