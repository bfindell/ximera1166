...
\begin{problem}
Sample response:  Using the parallel sides as bases, the two triangles have the same height as the trapezoid. 
\begin{image}
\begin{tikzpicture}[scale=0.8]
\draw [line width=0.8pt] (0.,0.)-- (2.,3.) -- (6.,3.)-- (7.,0.) -- cycle;
\draw [line width=0.8pt] (0.,0.)-- (6.,3.);
...
\end{image}
 ...
 The area of the trapezoid is the $\answer[format=string]{sum}$ of the areas of the triangles: 
\[
