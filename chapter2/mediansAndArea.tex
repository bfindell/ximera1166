...
This makes sense from the way the six triangles are formed.  For example, $t_1 = t_2$ because segment $\answer{GD}$ is a $\answer[format=string]{median}$ of $\triangle \answer{AGB}$.
\begin{problem}
