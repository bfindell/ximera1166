...
$\triangle ABC$.
\fixnote{Need to prompt for AA in the first two steps. \\The 2017 EOC item calls AA a postulate, which it is not.  \\Should AA be called a criterion?  a theorem? a condition?}
\end{enumerate}
\end{problem}
