...
\item Based on the marked figure, $\triangle ACD\cong \triangle\answer[format=string]{BCD}$ by \wordChoice{\choice{SAS}\choice[correct]{SSS}\choice{SSA}\choice{ASA}\choice{HL}}. 
...
\item Based on the marked figure, $\triangle ACD\cong \triangle\answer[format=string]{BCD}$ by \wordChoice{\choice{SAS}\choice{SSS}\choice{SSA}\choice{ASA}\choice[correct]{HL}}. 
