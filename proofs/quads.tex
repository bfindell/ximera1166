...
\begin{tikzpicture}[node distance = 1.5cm, auto]
    ...
    \node [block, below of=g] (i) 
    	{$\overline{AC}\perp\overline{BX}$ (and thus $\overleftrightarrow{BD}$)};
...
In the proof above, $\triangle BAD \cong \triangle BCD$ by $\answer[format=string]{SSS}$. 
\begin{problem}
In the proof above, $\triangle ABX \cong \triangle CBX$ by $\answer[format=string]{SAS}$.  
