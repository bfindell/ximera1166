...
\fixnote{Should call it $\angle ABC$ because of the new segment. Or maybe note this earlier.}
\end{enumerate}
\end{problem}

\begin{problem}

\fixnote{New problem about relationship between inscribed angle and central angle.}
