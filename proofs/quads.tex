...
%\item Then $R(\overleftrightarrow{AB})=\overleftrightarrow{CD}$ because it is the unique line through $C$ parallel to $\overleftrightarrow{AB}$.  
%\item Then $R(\overleftrightarrow{AD})=\overleftrightarrow{CB}$ because it is the unique line through $C$ parallel to $\overleftrightarrow{AD}$.  (Also vice versa.)
