...
\begin{question}
Write the words COKE and PEPSI in capital letters so that they read vertically.  Use a mirror to look at a reflection of the words.  Which word can appear the same on the can as in the mirror?  $\answer[format=string]{COKE}$
\begin{question}
