...
\begin{enumerate}
\item Beginning with the given figure on the left, draw $\overline{CD}$ and mark the figure so that this new segment is a(n) \wordChoice{\choice{median}\choice[correct]{angle bisector}\choice{perpendicular bisector}\choice{altitude}}.

\item Based on the marked figure, $\triangle ACD\cong \triangle\answer[format=string]{BCD}$ by \wordChoice{\choice[correct]{SAS}\choice{SSS}\choice{SSA}\choice{ASA}\choice{HL}}. 
...
\begin{enumerate}
\item Beginning with the given figure on the left, draw $\overline{CD}$ and mark the figure so that this new segment is a(n) \wordChoice{\choice[correct]{median}\choice{angle bisector}\choice{perpendicular bisector}\choice{altitude}}.

\item Note that we marked $\overline{CD}\cong \overline{CD}$ because the segment is congruent to itself.  

\item Based on the marked figure, $\triangle ADC\cong \triangle\answer[format=string]{BDC}$ by \wordChoice{\choice{SAS}\choice[correct]{SSS}\choice{SSA}\choice{ASA}\choice{HL}}. 

\item Finally, because corresponding parts of congruent triangles are congruent, we have shown that $\angle A\cong \angle\answer[format=string]{B}$, as desired. 
\end{enumerate}
\end{problem}


\begin{problem}
\textbf{Complete Elle's proof.} 
...
\begin{enumerate}
\item Beginning with the given figure on the left, draw $\overline{CD}$ and mark the figure so that this new segment is a(n) \wordChoice{\choice{median}\choice{angle bisector}\choice{perpendicular bisector}\choice[correct]{altitude}}.

\item Based on the marked figure, $\triangle CDA\cong \triangle\answer[format=string]{CDB}$ by \wordChoice{\choice{SAS}\choice{SSS}\choice{SSA}\choice{ASA}\choice[correct]{HL}}. 
...
%\draw [fill=qqqqff] (1.,0.) circle (1.2pt);
%\draw[color=qqqqff] (0.97,-0.2) node {$D$};
\draw (1,-0.6) node[align=center] {Lissy's figure 1};
\end{scriptsize}
\end{scope}
...
\begin{scriptsize}
\draw [fill=qqqqff] (0.,0.) circle (1.2pt);
\draw[color=qqqqff] (-0.18,-0.13) node {$B$};
\draw [fill=qqqqff] (2.,0.) circle (1.2pt);
\draw[color=qqqqff] (2.18,-0.13) node {$A$};
\draw [fill=qqqqff] (1.,2.2) circle (1.2pt);
\draw[color=qqqqff] (1.14,2.45) node {$C$};
%\draw [fill=qqqqff] (1.,0.) circle (1.2pt);
%\draw[color=qqqqff] (0.97,-0.2) node {$D$};
\draw (1,-0.6) node[align=center] {Lissy's figure 2};
\end{scriptsize}
\end{scope}
\end{tikzpicture}
\end{image}
...
\item Lissy draws and marks two figures illustrating the symmetry and claims that  $\triangle ACB\cong \triangle\answer[format=string]{BCA}$ by \wordChoice{\choice[correct]{SAS}\choice{SSS}\choice{SSA}\choice{ASA}\choice{HL}}. 
