...
\fixnote{Below are three different brief proofs that omit details.  Which of the details should be included?}

\begin{enumerate}

\item It must be that $\angle 1\cong \angle 3$ because they are both \wordChoice{\choice{complementary}\choice[correct]{supplementary}\choice{opposite}} to $\angle 2$.
...
\]
By comparing the two equations, it might be clear that $m\angle 1=m\angle 3$.  Other students may need to do some algebra.  
}

\item A rotation of $180^\circ$ about $P$ maps $m$ onto itself, maps $n$ onto itself, and swaps $\angle 1$ and $\angle 3$.  Because rotations preserve angle measures, it must be that $\angle 1\cong \angle 3$.  
...
\item Reflecting about the bisector of $\angle 2$ swaps $\angle 1$ and $\angle 3$.  Because reflections preserve angle measures, it follows that $\angle 1\cong \angle 3$. 
