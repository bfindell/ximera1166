...
\textbf{Note}: The congruence of corresponding angles now follows from the congruence of vertical angles.  But here is another approach that uses a translation.  
...
\textbf{Note:} This theorem is the $\answer[format=string]{converse}$ of the previous theorem about alternate interior angles.
\end{theorem}
