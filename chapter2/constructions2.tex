...
\item We know that altitude $\overline{BF}$ bisects $\angle ABC$ because $\triangle ABC$ is $\answer[format=string]{isosceles}$, in which an altitude to the base also bisects the vertex angle.  The congruent angles are marked with $\answer{\alpha}$. 
