...
\draw [color=white] (-2.,9.) circle (0.2pt);
\draw [color=white] (10.,9.) circle (0.2pt);
\end{scriptsize}
\end{tikzpicture}
\end{image}
...
\begin{freeResponse}
\begin{hint}
In Bart's triangulation, the interior angles of the quadrilateral are composed only of interior angles of the triangles.  But in Brad's triangulation, a new angle has been created with a vertex between $A$ and $D$.  Also notice that part of interior angle $C$ has been lost!  
\end{hint}
\end{freeResponse}
\end{problem}
