...
%\clip(-4.66,-0.38) rectangle (11.42,3.38);
\draw [line width=0.8pt] (0.,0.)-- (2.,3.);
\draw [line width=0.8pt] (2.,3.)-- (6.,3.);
\draw [line width=0.8pt] (6.,3.)-- (7.,0.);
\draw [line width=0.8pt] (7.,0.)-- (0.,0.);
...
\begin{freeResponse}
\begin{hint}
Using the parallel sides as bases, the two triangles have the same height as the trapezoid. 
\begin{image}
\begin{tikzpicture}[scale=0.8,line cap=round,line join=round,>=triangle 45,x=1.0cm,y=1.0cm]
%\clip(-4.66,-0.38) rectangle (11.42,3.38);
\draw [line width=0.8pt] (0.,0.)-- (2.,3.);
...
\draw [line width=0.8pt,dash pattern=on 3pt off 3pt] (0.,0.)-- (0.,3.);
\draw [line width=0.8pt,dash pattern=on 3pt off 3pt] (0.,3.)-- (2.,3.);
\draw[color=black] (3.5,-0.3) node {$b_1$};
\draw[color=black] (3.7,3.3) node {$b_2$};
\draw[color=black] (5.7,1.4) node {$h$};
\draw[color=black] (-0.3,1.4) node {$h$};
\draw [fill=white] (-4.,0.) circle (0.2pt);
\draw [fill=white] (11.,0.) circle (0.2pt);
\end{tikzpicture}
%\includegraphics{trap.png}
\end{image}
 ...
 The area of the trapezoid is the sum of the areas of the triangles: 
\[
...
%\clip(-4.66,-0.38) rectangle (11.42,3.38);
\draw [line width=0.8pt] (0.,0.)-- (2.,3.);
\draw [line width=0.8pt] (2.,3.)-- (8.,3.);
\draw [line width=0.8pt] (8.,3.)-- (6.,0.);
\draw [line width=0.8pt] (6.,0.)-- (0.,0.);
\draw [fill=white] (-4.,0.) circle (0.2pt);
...
\begin{tikzpicture}[scale=0.8,line cap=round,line join=round,>=triangle 45,x=1.0cm,y=1.0cm]
\draw [line width=0.8pt] (0.,0.)-- (2.,3.);
\draw [line width=0.8pt] (2.,3.)-- (9.,3.);
\draw [line width=0.8pt] (9.,3.)-- (7.,0.);
\draw [line width=0.8pt] (7.,0.)-- (0.,0.);
\draw [line width=0.8pt,dash pattern=on 3pt off 3pt] (9.,0.)-- (9.,3.);
\draw [line width=0.8pt,dash pattern=on 3pt off 3pt] (7.,0.)-- (9.,0.);
...
\begin{image}
\begin{tikzpicture}[scale=0.8,line cap=round,line join=round,>=triangle 45,x=1.0cm,y=1.0cm]
\draw [line width=0.8pt] (0.,0.)-- (5.,3.);
\draw [line width=0.8pt] (5.,3.)-- (8.,3.);
\draw [line width=0.8pt] (8.,3.)-- (3.,0.);
\draw [line width=0.8pt] (3.,0.)-- (0.,0.);
\draw [line width=0.8pt,dash pattern=on 3pt off 3pt] (8.,0.)-- (8.,3.);
\draw [line width=0.8pt,dash pattern=on 3pt off 3pt] (3.,0.)-- (8.,0.);
...
%\draw [line width=0.8pt,dash pattern=on 3pt off 3pt] (5.,3.)-- (5.,0.);
\draw [line width=0.8pt,dash pattern=on 3pt off 3pt] (0.,0.)-- (0.,3.);
\draw [line width=0.8pt,dash pattern=on 3pt off 3pt] (0.,3.)-- (5.,3.);
\draw[color=black] (1.5,-0.2) node {$b$};
\draw[color=black] (5.5,-0.2) node {$x$};
\draw[color=black] (8.25,1.4) node {$h$};
\draw [fill=white] (-4.,0.) circle (0.2pt);
\draw [fill=white] (12.,0.) circle (0.2pt);
\end{tikzpicture}
%\includegraphics{paragiorgio.png}
