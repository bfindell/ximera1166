...
Simon's claim that $\triangle ACD\cong \triangle BCD$ by SAS ignores the given: 
$\overline{AC}\cong \overline{BC}$, which means that the proof would work for any triangle.

Simon's claim that $\triangle ACD\cong \triangle BCD$ by SSS ignores the marking that $\angle CDA$ 
and $\angle CDB$, which means that the proof is as though $\overline{CD}$ is a median.   
