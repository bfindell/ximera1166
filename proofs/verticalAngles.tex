...
\begin{problem}
Which of the following ideas can lead to a proof that vertical angles are congruent? 
\begin{selectAll}
\choice{adjacent complementary angles}
\choice[correct]{adjacent supplementary angles}
\choice{adjacent congruent angles}
\choice[correct]{reflectional symmetry}
\choice[correct]{rotational symmetry}
\choice{translational symmetry}
\end{selectAll}
