...
\wordChoice{\choice{add}\choice[correct]{subtract}\choice{multiply}}
the area ($C$) of the small right triangle (with base $\answer{x}$): 
\begin{align*}
\mathrm{Area} = A &=  \answer{\frac{h(b+x)}{2}} - \answer{\frac{hx}{2}} \\
   &= \frac{hb+hx}{2} - \frac{hx}{2} \\
   &= \left(\frac{hb}{2} + \frac{hx}{2}\right) - \frac{hx}{2} \\
   &= \answer{\frac{hb}{2}}
\end{align*}
\begin{problem}
