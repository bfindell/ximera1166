...
\begin{scriptsize}
\draw[color=white] (-2,0) circle (1pt);
\draw[color=white] (4,0) circle (1pt);
...
\item $\angle DAC$ and $\angle BAD$ are $\answer[format=string]{complementary}$ because they are adjacent angles that form $\angle BAC$, which is \wordChoice{\choice[correct]{right}\choice{acute}\choice{obtuse}}.  

\item $\angle B \cong \angle DAC$ because they are both complementary to $\angle \answer[format=string]{BAD}$.  
