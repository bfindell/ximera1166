...
\textbf{Answer:}  For a perimeter of 20, the maximum-area rectangle would measure $\answer{5}$ feet by $\answer{5}$ feet, for an area of $\answer{25}$ square feet.  More generally, for a fixed perimeter, the rectangle with maximum area is a $\answer[format=string]{square}$.
