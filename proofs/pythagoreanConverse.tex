...
Suppose $a^2+b^2=\answer{c^2}$.  We want to prove that the triangle must be $\answer[format=string]{right}$, and that the $\answer[format=string]{hypotenuse}$ is $c$.  Until we show that $\angle C$ is a right angle, we must consider the possibility that it is not.  
