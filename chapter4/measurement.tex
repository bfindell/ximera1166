...
The 1600 meters race is $\answer{10.2187}$ yards \wordChoice{\choice[correct]{shorter}\choice{longer}} than 1 mile.  
...
\begin{freeResponse}
\begin{hint}
From a picture of a square yard and a square foot, it is not hard to see that it takes 9 square feet to cover 1 square yard.  (Draw a picture.)
\end{hint}
\begin{hint}
\[
